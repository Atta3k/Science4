...
public class PersonalCalTaxServiceLocator extends org.apache.axis.client.Service implements PersonalCalTaxService {

    public PersonalCalTaxServiceLocator() {
    }


    public PersonalCalTaxServiceLocator(org.apache.axis.EngineConfiguration config) {
        super(config);
    }

    public PersonalCalTaxServiceLocator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName) throws javax.xml.rpc.ServiceException {
        super(wsdlLoc, sName);
    }
    ...
    public PersonalCalTax_PortType getCalTax(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            PersonalCalTaxSoapBindingStub _stub = new PersonalCalTaxSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (PersonalCalTax_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                PersonalCalTaxSoapBindingStub _stub = new PersonalCalTaxSoapBindingStub(new java.net.URL(CalTax_address), this);
                _stub.setPortName(getCalTaxWSDDServiceName());
                return _stub;
            }
        }
